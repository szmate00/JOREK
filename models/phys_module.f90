...
module phys_module
  ...
  real*8  :: sheath_weak_beta     !< Penalty coefficient for bcs%sheath_zj_weak. The boundary term scales as h while the zj equation's own diagonal scales as h^2, so beta must scale as 1/h to be comparable - Nitsche convention beta = C*p^2/h with p the polynomial degree (3 here). Too small under-enforces the characteristic, too large swamps zj = Delta*psi and recovers a Gauss-point Dirichlet. Scan it and check the answer does not move
