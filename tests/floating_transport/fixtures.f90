...
module phys_module
  ...
  integer :: floating_u_prof_every=0, index_now=0, sheath_Te_smooth=0
  ...
  logical :: sheath_j_current_row=.false., sheath_j_cancel_flux=.false., sheath_j_cancel_vis=.true., sheath_j_cancel_kin=.true., sheath_j_release_der=.true.
