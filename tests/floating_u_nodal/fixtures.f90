! Serial dependency fixtures (stub modules) for compiling the PRODUCTION model600 boundary assembler and the
! wall diagnostics without MPI. WITH_TiTe build, one toroidal plane, bicubic elements. Not a simulation.
...
module phys_module
  ...
  real*8  :: sheath_j_ion_slope=0.d0,sheath_j_ramp_time=-1.d0,sheath_j_ramp_alpha0=0.05d0
  real*8  :: tstep_n(10)=0.d0
  integer :: nstep_n(10)=0
...
module mpi_mod
  implicit none
  integer,parameter :: MPI_COMM_WORLD=0,MPI_DOUBLE_PRECISION=1,MPI_2DOUBLE_PRECISION=2,MPI_MINLOC=3,MPI_MIN=4,MPI_MAX=5,MPI_SUM=6
contains
