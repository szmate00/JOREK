...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(sheath_flux_on_sheath_j,1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(sheath_j_ramp_alpha0,  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,sheath_flux_on_sheath_j,1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,sheath_j_ramp_alpha0,  1,MPI_REAL8,MPI_COMM_WORLD,ierr)
