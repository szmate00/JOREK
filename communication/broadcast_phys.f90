...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(wall_diag,              1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(wall_diag_every,        1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(wall_diag_profile_every,1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(mach1_weak_drift_style, 1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(mach1_weak_qalf_min,    1,MPI_DOUBLE_PRECISION,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,wall_diag,              1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,wall_diag_every,        1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,wall_diag_profile_every,1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,mach1_weak_drift_style, 1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,mach1_weak_qalf_min,    1,MPI_DOUBLE_PRECISION,MPI_COMM_WORLD,ierr)
