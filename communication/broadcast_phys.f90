...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(sheath_j_pin_current,   1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(sheath_j_ohm,           1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,sheath_j_pin_current,   1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,sheath_j_ohm,           1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
