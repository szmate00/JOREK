...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(sheath_wall_diff,       1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,sheath_wall_diff,       1,MPI_REAL8,MPI_COMM_WORLD,ierr)
