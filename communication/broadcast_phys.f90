...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(bohm_drift_compatible,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(bohm_drift_clip,        1,MPI_REAL8,  buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,bohm_drift_compatible,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,bohm_drift_clip,        1,MPI_REAL8,  MPI_COMM_WORLD,ierr)
