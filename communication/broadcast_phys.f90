...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(floating_Lambda      ,  1,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(floating_V_wall      ,  1,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(floating_u_relax     ,  1,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(floating_ramp_time   ,  1,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(floating_Lambda_local,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(floating_min_bn      ,  1,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(floating_u_value_only,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(floating_start_time   ,  1,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(floating_gauge_removal,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(floating_amp_ramp     ,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(mach1_psib_floor      ,  1,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(mach1_exb_term        ,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(floating_keep_u_row   ,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(grid_leg_wall_match ,   1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,floating_Lambda      ,  1,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,floating_V_wall      ,  1,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,floating_u_relax     ,  1,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,floating_ramp_time   ,  1,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,floating_Lambda_local,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,floating_min_bn      ,  1,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,floating_u_value_only,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,floating_start_time   ,  1,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,floating_gauge_removal,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,floating_amp_ramp     ,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,mach1_psib_floor      ,  1,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,mach1_exb_term        ,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,floating_keep_u_row   ,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,grid_leg_wall_match ,   1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
