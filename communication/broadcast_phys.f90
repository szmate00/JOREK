...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(visco_kinematic,        1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(visco_par_kinematic,    1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,visco_kinematic,        1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,visco_par_kinematic,    1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
