...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(diamag_heat_conv,       1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(keep_current_mask_pfr_only,1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,diamag_heat_conv,       1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,keep_current_mask_pfr_only,1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
