...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(flux_lim,               1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(alpha_flux_lim,         1,MPI_REAL8,  buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(alpha_flux_lim_e,       1,MPI_REAL8,  buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(alpha_flux_lim_i,       1,MPI_REAL8,  buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(eta_num_T_dependent,    1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(visco_num_T_dependent,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,flux_lim,               1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,alpha_flux_lim,         1,MPI_REAL8,  MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,alpha_flux_lim_e,       1,MPI_REAL8,  MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,alpha_flux_lim_i,       1,MPI_REAL8,  MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,eta_num_T_dependent,    1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,visco_num_T_dependent,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
